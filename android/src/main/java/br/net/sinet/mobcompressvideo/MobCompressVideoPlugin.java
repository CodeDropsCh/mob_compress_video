package br.net.sinet.mobcompressvideo;
...
/** MobCompressVideoPlugin */
public class MobCompressVideoPlugin implements MethodCallHandler {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "mob_compress_video");
    channel.setMethodCallHandler(new MobCompressVideoPlugin());
  }
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    if (call.method.equals("compress")) {
        ...
        String origem = call.argument("origem");
        String destino = call.argument("destino");

        String command = "-y -i "+origem+" -crf 24 "+destino;
